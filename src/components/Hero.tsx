  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-b from-purple-50 via-blue-50 to-white">
      ...
      <div className="relative z-10 text-center max-w-3xl mx-auto px-6">
        ...
        <h1 ref={titleRef} className="text-6xl md:text-7xl font-bold mb-8 bg-gradient-to-r from-purple-600 via-blue-600 to-purple-600 text-transparent bg-clip-text leading-tight">
          Creating Ok
          <span className="block mt-2">Projects</span>
        </h1>
        <p className="text-xl text-gray-600 mb-12 animate-fade-in delay-200 max-w-2xl mx-auto leading-relaxed">
          I make iOS sideloading easily accessible for all people
        </p>
        <button
          onClick={() => document.getElementById('about')?.scrollIntoView({ behavior: 'smooth' })}
          className="px-8 py-4 bg-gradient-to-r from-[#1EAEDB] to-[#0EA5E9] text-white rounded-xl transition-all hover:scale-105 hover:shadow-lg text-lg font-medium shadow-md"
        >
          Learn More
        </button>
      </div>
